...
private fun StravArtApp(
    ...
    val actions = remember(viewModel) {
        RouteActions(
            ...
            setPlacementMode = viewModel::setPlacementMode,
            setSearchRadius = viewModel::setSearchRadius,
            setDistanceTolerance = viewModel::setDistanceTolerance,
            adoptPlacement = viewModel::adoptPlacement,
            generate = viewModel::generate,
            cancelGeneration = viewModel::cancelGeneration,
